...
// EndOfUtterance is a sentinel sent on the OutputChannel to indicate the
// end of a single TTS utterance. The Twilio output worker emits a Twilio
// `mark` event when this sentinel is received so Twilio knows an utterance
// finished.
